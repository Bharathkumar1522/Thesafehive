      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          <Button
            to="/contact"
            size="md"
            className="bg-gradient-to-r from-[#4CAF50] to-[#66BB6A] hover:from-[#45a049] hover:to-[#5da85d] text-white px-6 py-2.5 text-base rounded-2xl shadow-2xl hover:shadow-[#4CAF50]/40 transition-all duration-300 transform hover:scale-105 group border-2 border-white/20"
          >
