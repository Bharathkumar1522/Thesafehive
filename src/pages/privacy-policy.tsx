...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800">
      <h1 className="text-2xl font-semibold mb-6 text-center">Privacy Policy – The SafeHive</h1>

      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">1. Introduction</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">2. Data We Collect</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">3. Purpose of Collection</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">4. Legal Basis</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">5. Storage & Security</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">6. Your Rights</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">7. Retention</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">8. Third Parties</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">9. Cross-Border Transfers</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">10. Breach Notification</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">11. Region-Specific Rights</h2>
        <p className="mb-2">
      ...
      <section className="mb-5">
        <h2 className="text-lg font-medium mb-1">12. Blog and Health Disclaimer</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-medium mb-1">13. Contact</h2>
        <p>
          For any questions, concerns, or to exercise your privacy rights, please contact us at: <br />
          <strong>Email:</strong> [Insert your privacy email]
        </p>
      </section>
    </div>
  );
