...
import { Leaf, Building, Search, Shield, AlertTriangle, Award, MessageSquare, Eye, Microscope, TrendingUp } from "lucide-react";
    ...
    <div className="pt-16">
      ...
      >
        ...
        <div className="container mx-auto px-4 pt-24 pb-12 md:pt-32 md:pb-24 relative z-10 text-center">
          ...
          <HeroVideo 
            src="https://youtu.be/BfHYMjNLj1o"
      ...
      <section className="py-16 md:py-24 bg-gray-50 ">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-4xl font-heading font-bold text-gray-900 mb-4">Our <span className="text-green-600">Values</span></h2>
        ...
        <section className="py-24 px-6 bg-gradient-to-r from-green-50 to-white relative overflow-hidden">
          <div className="max-w-6xl mx-auto text-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <h2 className="text-4xl font-bold text-gray-900 mb-6 font-heading">How We <span className="text-green-600">Hand-Pick </span>Products</h2>
              
              <div className="max-w-4xl mx-auto space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  At The SafeHive, our mission is to bring you products that are truly safe, natural, and reliable. 
                  That's why every product goes through a careful initial independent review process before it reaches you.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            <div className="relative max-w-5xl mx-auto">
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 w-1 top-0 bottom-0 md:block hidden">
                <div 
                  ...
                  style={{
                    height: '100%',
                    backgroundImage: 'repeating-linear-gradient(to bottom, #4CAF50 0, #4CAF50 8px, transparent 8px, transparent 16px)'
                  }}
                ></div>
              </div>
                ...
                {[
                  {
                    ...
                    description: "We review the company's background, ethics, sustainability record, and reputation using publicly available information such as websites, reports, press coverage, and recall histories.",
                    icon: Building,
                    image: "https://images.unsplash.com/photo-1758876020300-76a782ca51c6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMHJlc2VhcmNoJTIwb2ZmaWNlJTIwYW5hbHlzaXN8ZW58MXx8fHwxNzU5MTQ3NDkyfDA&ixlib=rb-4.1.0&q=80&w=1080"
                  },
                  {
                    title: "Ingredient List Check",
                    description: "We examine ingredient lists from product packaging, official brand websites, and reliable databases (such as INCI and EWG's Skin Deep).",
                    icon: Search,
                    image: "https://images.unsplash.com/photo-1748261347902-451fb437e8fb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYWJvcmF0b3J5JTIwaW5ncmVkaWVudHMlMjB0ZXN0aW5nfGVufDF8fHx8MTc1OTE0NzQ5NXww&ixlib=rb-4.1.0&q=80&w=1080"
                  },
                  {
                    title: "Safety Cross-Check",
                    description: "Every ingredient is compared against authoritative safety sources like WHO, IARC, ECHA, and peer-reviewed research to ensure it is free from harmful or toxic substances.",
                    icon: Shield,
                    image: "https://images.unsplash.com/photo-1702623945459-d2ebfec1ca31?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzYWZldHklMjBwcm90ZWN0aW9uJTIwc2hpZWxkfGVufDF8fHx8MTc1OTEyNzM1OXww&ixlib=rb-4.1.0&q=80&w=1080"
                  },
                  {
                    title: "Precautionary Principle",
                    description: "If an ingredient is vague (like \"fragrance\") or under safety debate, we exclude the product rather than take risks.",
                    icon: AlertTriangle,
                    image: "https://images.unsplash.com/photo-1635308634829-75cb644123cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXV0aW9uJTIwd2FybmluZyUyMHNpZ258ZW58MXx8fHwxNzU5MTQ3NTAyfDA&ixlib=rb-4.1.0&q=80&w=1080"
                  },
                  {
                    title: "Certification Verification",
                    description: "We verify visible third-party certifications (organic, cruelty-free, eco-friendly) shown on packaging or official product listings.",
                    icon: Award,
                    image: "https://images.unsplash.com/photo-1715173679369-18006e84d6a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjZXJ0aWZpY2F0ZSUyMGJhZGdlJTIwdmVyaWZpY2F0aW9ufGVufDF8fHx8MTc1OTE0NzUwNXww&ixlib=rb-4.1.0&q=80&w=1080"
                  },
                  {
                    title: "Ongoing Monitoring",
                    description: "Even after approval, we track new studies, recalls, and consumer feedback. Products that no longer meet our standards are immediately removed.",
                    icon: Eye,
                    image: "https://images.unsplash.com/photo-1758577515333-e71b713059f1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb25pdG9yaW5nJTIwdHJhY2tpbmclMjBkYXRhfGVufDF8fHx8MTc1OTE0NzUwOHww&ixlib=rb-4.1.0&q=80&w=1080"
                  },
                  {
                    title: "Customer Transparency",
                    description: "We simplify all this research into clear, honest product information so you always know what's inside and why it's safe.",
                    icon: MessageSquare,
                    image: "https://images.unsplash.com/photo-1654166602082-d18e7cd4bdac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cmFuc3BhcmVuY3klMjBjb21tdW5pY2F0aW9uJTIwY2xlYXJ8ZW58MXx8fHwxNzU5MTQ3NTExfDA&ixlib=rb-4.1.0&q=80&w=1080"
                  }
                ].map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div className="w-4 h-4 bg-[#4CAF50] rounded-full shadow-lg border-4 border-white">
                        </div>
                      </motion.div>
